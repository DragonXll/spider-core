...
def getSession():
    headers = {
        ...
        'Pragma': 'no-cache',
        'Referer': 'http://222.135.190.229:8006/indext.aspx?stylecode=',
        'Upgrade-Insecure-Requests': '1',
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Safari/537.36',
    }
    # 设置sessionId
    response = requests.get('http://222.135.190.229:8006/Login.aspx', headers=headers, verify=False)
...
def getHuaKuai():
    ...
    headers = {
        ...
        'Referer': 'http://222.135.190.229:8006/Login.aspx',
    ...
    response = requests.get(
        'http://222.135.190.229:8006/ajax/SliderValidImg.ashx',
        params=params,
        cookies=cookies,
        headers=headers,
        verify=False,
...
def login():
    ...
    response = requests.post('http://222.135.190.229:8006/Ajax/Login.ashx', params=params, cookies=cookies,
    ...
    data = {
        'p1': 'b0ba08afb93c89a9f36bdd745a90f325',
        'p2': '4077996a628b1141a3164be1bac34958',
        'sx': h.get_value("code"),
    }

    response = requests.post(
        'http://222.135.190.229:8006/Ajax/Login.ashx',
        params=params,
        cookies=cookies,
        headers=headers,
        data=data,
