...
def getEnterpriseInfo(page):
    ...
    response = requests.post(
        'http://60.214.99.139:8006/Web6/ajax/Report/Statistics/Record/EntSubDetailAnalysis.ashx',
        cookies=cookies,
        headers=headers,
        data=data,
        verify=False,
...
def getBasicInfo(ecode):
    ...
    response = requests.post(
        'http://60.214.99.139:8006/zdjkbak/BasicInfo/ajax/EnterpriseInfo/BasicInfo/BasicInfo.ashx',
        cookies=cookies,
        headers=headers,
        data=data,
        verify=False,
