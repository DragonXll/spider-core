# coding: utf-8
from sqlalchemy import BigInteger, Column, DateTime, Index, Integer, TIMESTAMP, text
...
class TAirCateringMinute(Base):
    __tablename__ = 't_air_catering_minute'
    __table_args__ = (
        Index('ids_index', 'CREDIT_NO', 'MONITOR_TIME', unique=True),
        {'comment': '餐饮油烟_监控数据【分】'}
    )
