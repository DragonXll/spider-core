# coding: utf-8
from sqlalchemy import BigInteger, Column, DateTime, Index, String, TIMESTAMP, text
...
class TPseMonitorGasHour(Base):
    __tablename__ = 't_pse_monitor_gas'
    __table_args__ = (
        Index('index', 'MONITOR_TIME', 'COMPANY_NAME', 'OUTPOINT_ID', 'SYS_CITY_CODE', 'SYS_COUNTY_CODE', unique=True),
        {'comment': '污染源_废气(小时)'}
    )
    ...
    STATUS_201 = Column(String(20), comment='二氧化碳-状态')
    ...
    STATUS_203 = Column(String(20), comment='氮氧化物-状态')
    ...
    STATUS_207 = Column(String(20), comment='颗粒物-状态')
    ...
    CBBS_221 = Column(VARCHAR(10), comment='氯化氢-超标倍数')
    ...
    CBBS_222 = Column(VARCHAR(10), comment='氟化氢-超标倍数')
